...
public class HotAndColdGAme : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        print("A random number between 0 and 100 has been chose. Your goal is to find this number in the less attempts possibles");
        print("Enter in your guess and then press the spacebutton to submit it. Good luck!");
    }
